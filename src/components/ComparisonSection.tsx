      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex justify-center mb-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="relative bg-muted p-1 rounded-lg">
            <div className={`absolute top-1 left-1 h-10 bg-primary rounded-md transition-all duration-300 ${showAfter ? 'w-28 translate-x-28' : 'w-28'}`}></div>
            <Button
              variant="ghost"
              className={`relative z-10 h-10 px-6 transition-colors duration-300 ${!showAfter ? 'text-primary-foreground' : 'text-foreground'}`}
